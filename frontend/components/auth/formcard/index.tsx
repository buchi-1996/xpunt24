    ...
    <Card className={`${className}`}>
        ...
        <CardFooter>
            <div className='grid place-items-center justify-center w-full'>
                ...
                {isLogin && <Link href="/auth/forgot-password"><small className='text-gray-500 bg-gray-50 py-2 px-4 rounded-full hover:bg-gray-100 transition-colors'>Forgot password?</small></Link>}
